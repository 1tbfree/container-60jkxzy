...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-60jkxzy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-60jkxzy.containers.anotherwebservice.com/
...
```
git clone git@github.com:1tbfree/container-60jkxzy.git
cd container-60jkxzy
```
...
```
docker attach container-60jkxzy
```
